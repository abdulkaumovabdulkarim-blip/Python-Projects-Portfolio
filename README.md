...
| **Web Crawler** | Web crawler that starts at a target URL, fetches its HTML content, parses out all hyper-links, and recursively follows those links up to a specified depth. |
